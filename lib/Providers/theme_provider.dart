...
class ThemeProvider with ChangeNotifier {
  ...
  onChanged(newColor, n) async {
    n == 1
        ...
        : hintColor = _toMaterialColor(newColor.hashCode);
    notifyListeners();
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt("primaryColor", primaryColor.value);
    prefs.setInt("accentColor", hintColor.value);
  }
  ...
  getThemeColors() async {
    ...
    hintColor = _toMaterialColor(prefs.getInt("hintColor") ?? 0xFFFFC107);
    notifyListeners();
  }
